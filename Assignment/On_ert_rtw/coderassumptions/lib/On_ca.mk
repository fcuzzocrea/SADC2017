###########################################################################
## Makefile generated for Simulink model 'On_ca'. 
## 
## Makefile     : On_ca.mk
## Generated on : Wed Nov 28 13:42:46 2018
## MATLAB Coder version: 4.1 (R2018b)
## 
## Build Info:
## 
## Final product: ./On_ca.a
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(MATLAB_ROOT)/toolbox/rtw/targets/pil/c -I$(START_DIR)/On_ert_rtw/coderassumptions -I$(START_DIR)/On_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(ARDUINO_SAM_ROOT)/hardware/sam/1.6.11/system/libsam -I$(ARDUINO_SAM_ROOT)/hardware/sam/1.6.11/system/CMSIS/CMSIS/Include -I$(ARDUINO_SAM_ROOT)/hardware/sam/1.6.11/system/CMSIS/Device/ATMEL -I$(ARDUINO_SAM_ROOT)/hardware/sam/1.6.11/cores/arduino -I$(ARDUINO_SAM_ROOT)/hardware/sam/1.6.11/cores/arduino/avr -I$(ARDUINO_SAM_ROOT)/hardware/sam/1.6.11/variants/arduino_due_x -I/home/fcuzzocrea/.matlab/SupportPackages/R2018B/toolbox/target/supportpackages/arduinotarget/include -I/home/fcuzzocrea/.matlab/SupportPackages/R2018B/toolbox/target/supportpackages/arduinotarget/scheduler/include -I/home/fcuzzocrea/.matlab/SupportPackages/R2018B/toolbox/target/supportpackages/arduinobase/include -I/home/fcuzzocrea/.matlab/SupportPackages/R2018B/toolbox/target/shared/externalmode_daemon/include
...
DEFINES_ = -DCA_CHECK_FLOATING_POINT_ENABLED=1 -DMODEL=On -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0 -DUNIX -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=0 -DTID01EQ=0 -DTERMFCN=1 -DONESTEPFCN=1 -DMAT_FILE=0 -DMULTI_INSTANCE_CODE=0 -DINTEGER_CODE=0 -DMT=0 -DEXIT_FAILURE=1 -DEXTMODE_DISABLEPRINTF -DEXTMODE_DISABLETESTING -DEXTMODE_DISABLE_ARGS_PROCESSING=1 -DSTACK_SIZE=64 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DRT -DMW_TIMERID=9 -DMW_TIMERCOUNT=656250 -DMW_SAM_CLOCKID=TC_CMR_TCCLKS_TIMER_CLOCK4 -D_RTT_BAUDRATE_SERIAL0_=9600 -D_RTT_BAUDRATE_SERIAL1_=9600 -D_RTT_BAUDRATE_SERIAL2_=9600 -D_RTT_BAUDRATE_SERIAL3_=9600 -D_RTT_ANALOG_REF_=0 -DCA_CHECK_LONG_LONG_ENABLED=0 -DCA_CHECK_DAZ_ENABLED=1
...
SRCS = $(MATLAB_ROOT)/toolbox/rtw/targets/pil/c/coder_assumptions_hwimpl.c $(MATLAB_ROOT)/toolbox/rtw/targets/pil/c/coder_assumptions_flt.c $(START_DIR)/On_ert_rtw/coderassumptions/On_ca.c
...
OBJS = coder_assumptions_hwimpl.o coder_assumptions_flt.o On_ca.o
...
%.o : $(START_DIR)/On_ert_rtw/coderassumptions/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.S.o : $(START_DIR)/On_ert_rtw/coderassumptions/%.s
	$(AS) $(ASFLAGS) -o $@ $<
...
%.o : $(START_DIR)/On_ert_rtw/coderassumptions/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


%.o : $(START_DIR)/On_ert_rtw/coderassumptions/%.cc
	$(CPP) $(CPPFLAGS) -o $@ $<
...
%.o : $(START_DIR)/On_ert_rtw/coderassumptions/%.cxx
	$(CPP) $(CPPFLAGS) -o $@ $<


%.o : $(START_DIR)/On_ert_rtw/coderassumptions/lib/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.S.o : $(START_DIR)/On_ert_rtw/coderassumptions/lib/%.s
	$(AS) $(ASFLAGS) -o $@ $<
...
%.o : $(START_DIR)/On_ert_rtw/coderassumptions/lib/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


%.o : $(START_DIR)/On_ert_rtw/coderassumptions/lib/%.cc
	$(CPP) $(CPPFLAGS) -o $@ $<
...
%.o : $(START_DIR)/On_ert_rtw/coderassumptions/lib/%.cxx
	$(CPP) $(CPPFLAGS) -o $@ $<
